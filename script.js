...
const btnLoveBomb = document.getElementById('btnLoveBomb');
...
function startMusic() {
    ...
    audio.play().then(() => {
        ...
        alert('Không thể phát nhạc. Kiểm tra file tinhyeu.mp3 có cùng thư mục không!');
    });
}
...
// ===== NÚT "GỬI YÊU THƯƠNG" =====
btnLoveBomb.addEventListener('click', () => {
    burstHearts(18);
    burstConfetti(40);
    spawnPetals(20);
    startFireworks();
...
console.log('💖 anh đã sẵn sàng yêu tiên');